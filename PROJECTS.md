# Budots Media — Projects

All known projects by Budots Media / Budots Media Philippines, compiled 2026-07-05 from:
[YouTube channel](https://www.youtube.com/channel/UCq7YUYIdRcTE7oIslPAYTUA), [bartsakwerda.com/budots-media](https://bartsakwerda.com/budots-media/), [budotsmedia.webflow.io](https://budotsmedia.webflow.io), [budotsmediaph.co](https://budotsmediaph.co), [Cebuano Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media), [Atlas Commune](https://atlascommune.com/blogs/community/big-canoe-bigger-dream), and `instructions/*.md` in this repo.

Format: `YEAR-MONTH · CLIENT — description — link`. Month omitted where unknown; ⚠ = from internal notes only, not yet verified on the web.

## Dated projects (newest first)

- **2026-07 · Philippines Outrigger Canoe Club (POCC)** — Dragon-boat regatta at Shangri-La Mactan, Cebu; event video — [Video](https://www.youtube.com/watch?v=KIcZ4JUxLm8)
...
- **2026-01 · Neviann Sanchez** — Athlete feature short — [Video](https://www.youtube.com/shorts/tKxiK8gWFCY)
- **2026-01 · DVSHOP Sneakers Cebu** — Retail promo short — [Video](https://www.youtube.com/shorts/3F5xyTlEdIE)
- **2026-01 · Philippines Outrigger Canoe Club (POCC)** — Lapu-Lapu → Camotes 116 km paddle documentation — [Video](https://www.youtube.com/watch?v=HCaH_1grvK0)
- **2025-12 · Res Toe Run 2025** — Running-event coverage — [Video](https://www.youtube.com/shorts/QDNgth5-YUU)
- **2025-12 · AIDA Freedive Maribago** — Freediving coverage, Lapu-Lapu City — [Video](https://www.youtube.com/watch?v=e_25EcopAEg)
- **2025-12 · Cebu Island Hopping** — Tourism promo short — [Video](https://www.youtube.com/shorts/VIT7AkrM0O0)
...
- **2024-02 · Philippine GameDev Summit, Boracay** — Games-industry event (DTI / GameOps / GDAP) — [Story page](https://barts83eu.github.io/budotsmediaph-202606-fable5/stories/games-dev.html)
- **2023 · JPARK Island Resort — Brides at Triton** — Wedding-expo production, Triton Grand Ballroom — [Story page](https://barts83eu.github.io/budotsmediaph-202606-fable5/stories/brides-of-triton.html)
...
- **2021 · Cleevan Alegres** — Documentation of Mactan Island circumnavigation swim — [Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media)
...
- **2021-06 · Philippine Outrigger Canoe Club** — Paddle practice at Olango Island — [Story page](https://barts83eu.github.io/budotsmediaph-202606-fable5/stories/olango-practice.html)
- **2019 · Philippines tourism** — International-arrivals report data visualization — [Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media)

## Long-term / ongoing engagements

- **Department of Tourism Region 7 (DOT7)** — Official media supplier; long-term media-library stewardship — [Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media)
- **Camiguin Resorts** (incl. Nouveau Resort) ⚠ — Long-term media coverage
- **Green Concepts and Events, Cebu** — Long-term event-coverage collaboration — [Channel](https://www.youtube.com/watch?v=Yj8ox76LaJE)
- **Kalanggaman Island Tours** — Tourism site operated with Budots Media PH branding — [Website](https://kalanggaman.com)
- **Pinoy Athlete series** — Documentary series on Lapu-Lapu City athletes — [Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media)
- **Eskirmadors series** — Series promoting Filipino Martial Arts — [Wikipedia](https://ceb.wikipedia.org/wiki/Budots_Media)

## Undated portfolio work

- **NUSTAR Resort & Casino Cebu** — 3D advertisements for LED displays — [Portfolio](https://budotsmedia.webflow.io)
- **Philippines Outrigger Canoe Club Mactan** — Club video — [Video](https://www.youtube.com/watch?v=PobjNrDMUyY)
- **OC6 outrigger canoe 3D model** — Photogrammetry model on Sketchfab — [Model](https://sketchfab.com/3d-models/outrigger-canoe-oc6-d0644ab451e142a1bc9f0e18a4386a9b)
- **Philippines maps** — Dozens of flat and 3D maps for various clients — [Portfolio](https://budotsmedia.webflow.io)
- **International drone photogrammetry** — Diriyah (Riyadh), SM Seaside (Cebu), Dubai drone show, Sentosa (Singapore), Malaysia National Stadium, Putrajaya mosque (KL), Palawan islands — [Overview](https://bartsakwerda.com/budots-media/)
- **VR / 360° tourism & real-estate content** (2016 →) — [Medium](https://medium.com/@BartSakwerda/budots-media-our-productions-1948254d0bfe)
...
- **2017-12 · Cebu Chatbot & Call-center Automation Meetup** — First of its kind, IT Park, Cebu City — [Medium](https://medium.com/@BartSakwerda/budots-media-our-productions-1948254d0bfe)
- **2015 · Philippines Travel Company** — Tourism venture, Maribago
- **2015 · Cebu Japanese Meetup** ⚠

---

*Notes: the YouTube RSS feed only exposes the channel's 15 most recent uploads — older videos exist beyond it. budotsmediaph.com did not resolve at compile time (site down). Facebook sources are behind a login wall and were not fetched.*
